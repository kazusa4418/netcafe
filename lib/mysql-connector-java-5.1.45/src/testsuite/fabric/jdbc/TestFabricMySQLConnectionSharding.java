...
public class TestFabricMySQLConnectionSharding extends BaseFabricTestCase {
    ...
    /**
     * old.Test that we can create a table in the global group and see
     * it in other groups.
     */
    ...
    /**
     * old.Test that sharding works by creating data in two shards and making sure it's
    ...
    /**
     * old.Test that providing the query table(s) to the connection chooses
    ...
    /**
     * old.Test that providing several tables with conflicting shard mappings

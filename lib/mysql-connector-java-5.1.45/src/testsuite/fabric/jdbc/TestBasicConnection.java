...
public class TestBasicConnection extends BaseFabricTestCase {
    ...
    /**
     * old.Test that we can make a connection with a URL, given a server group name
     */
    ...
    /**
     * old.Test that we can connect with the data source, given a server group name
     */

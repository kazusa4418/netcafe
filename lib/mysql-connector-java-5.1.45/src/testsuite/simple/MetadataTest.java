...
public class MetadataTest extends BaseTestCase {
    ...
    private void createTestTable() throws SQLException {
        ...
        // old.Test compound foreign keys
        try {
     ...
     * 
     * old.Test for new syntax and support in DatabaseMetaData.getColumns().
     * 
    ...
    public void testGeneratedColumns() throws Exception {
        ...
        // old.Test GENERATED columns syntax.
        ...
        // old.Test data for generated columns.
        ...
        for (String connProps : new String[] { "useInformationSchema=false", "useInformationSchema=true" }) {
            ...
            // old.Test primary keys metadata.

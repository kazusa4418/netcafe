...
public class SplitDBdotNameTest extends BaseTestCase {
    ...
    public void testSplit() throws Exception {
        ...
        if ((resString != null)) {
            ...
            fail("old.Test 1.1 returned null resString");
        }

        //old.Test 1.2, toggle isNoBslashEscSet
        src = "`MyDatabase 1.0.1.0`.`Proc 1.v1`";
        resString = StringUtils.sanitizeProcOrFuncName(src);
        if ((resString != null)) {
            ...
            fail("old.Test 1.2 returned null resString");
        }

        //old.Test 2.1, weird SP name, no DB parameter
        src = "`Proc 1.v1`";
        resString = StringUtils.sanitizeProcOrFuncName(src);
        if ((resString != null)) {
            results = StringUtils.splitDBdotName(resString, null, "`", true);
            ...
            fail("old.Test 2.1 returned null resString");
        }

        //old.Test 2.2, toggle isNoBslashEscSet
        src = "`Proc 1.v1`";
        resString = StringUtils.sanitizeProcOrFuncName(src);
        if ((resString != null)) {
            results = StringUtils.splitDBdotName(resString, null, "`", false);
            ...
            fail("old.Test 2.2 returned null resString");
        }
    }
}
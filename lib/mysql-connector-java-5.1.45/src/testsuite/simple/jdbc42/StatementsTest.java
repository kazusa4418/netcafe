...
public class StatementsTest extends BaseTestCase {
    ...
    /**
     * old.Test shared test data validity.
     */
    ...
    /**
     * old.Test for Statement.executeLargeBatch(). Validate update count returned and generated keys.
     */
    ...
    /**
     * old.Test for Statement.executeLargeUpdate(String).
    ...
    /**
     * old.Test for Statement.executeLargeUpdate(String, _).
     * Validate update count returned and generated keys.
    ...
    /**
     * old.Test for PreparedStatement.executeLargeBatch().
     * Validate update count returned and generated keys.
     */
    ...
    /**
     * old.Test for PreparedStatement.executeLargeUpdate().
     * Validate update count returned and generated keys.
     * Case: without requesting generated keys.
     */
    ...
    /**
     * old.Test for CallableStatement.executeLargeBatch().
     * Validate update count returned and generated keys.
     */
    ...
    /**
     * old.Test for CallableStatement.executeLargeUpdate().
     * Validate update count returned and generated keys.
     */
    ...
    /**
     * old.Test for (ServerAccessManager)PreparedStatement.executeLargeBatch().
     * Validate update count returned and generated keys.
     */
    ...
    /**
     * old.Test for Statement.[get/set]LargeMaxRows().
     */
    ...
    /**
     * old.Test for PreparedStatement.setObject().
    ...
    /**
     * old.Test for PreparedStatement.setObject(), unsupported SQL types TIME_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE and REF_CURSOR.
     */
    ...
    /**
     * old.Test for CallableStatement.setObject().
     * Validate new methods as well as support for the types java.time.Local[Date][Time] and java.time.Offset[Date]Time.
     */
    ...
    /**
     * old.Test for CallableStatement.setObject(), unsupported SQL types TIME_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE and REF_CURSOR.
     */
    ...
    /**
     * old.Test for (ServerAccessManager)PreparedStatement.setObject().
     * Validate new methods as well as support for the types java.time.Local[Date][Time] and java.time.Offset[Date]Time.
     */
    ...
    /**
     * old.Test for (ServerAccessManager)PreparedStatement.setObject(), unsupported SQL types TIME_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE and REF_CURSOR.
     */
    ...
    /**
     * old.Test for CallableStatement.registerOutParameter().
     */
    ...
    /**
     * old.Test for CallableStatement.registerOutParameter(), unsupported SQL types TIME_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE and REF_CURSOR.
     */

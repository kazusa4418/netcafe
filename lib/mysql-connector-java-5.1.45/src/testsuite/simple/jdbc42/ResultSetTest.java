...
public class ResultSetTest extends BaseTestCase {
    ...
    /**
     * old.Test for ResultSet.updateObject(), non-updatable ResultSet behaviour.
     */
    ...
    /**
     * old.Test for (Updatable)ResultSet.[update|get]Object().
    ...
    /**
     * old.Test for (Updatable)ResultSet.updateObject(), unsupported SQL types TIME_WITH_TIMEZONE, TIMESTAMP_WITH_TIMEZONE and REF_CURSOR.
     */

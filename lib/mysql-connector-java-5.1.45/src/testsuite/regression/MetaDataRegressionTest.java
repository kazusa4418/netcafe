...
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    public void testBug3570() throws Exception {
        ...
        try {
            ...
            while (dbmdRs.next()) {
                ...
                //
                // TODO: ServerAccessManager needs to send these types correctly....
                //
    ...
    public void testBug4880() throws Exception {
        try {
            ...
            if (versionMeetsMinimum(4, 1)) {
                // ServerAccessManager doesn't send us enough information to detect LONGBLOB
                // type
    ...
    /**
     * old.Test fix for BUG#68098 - DatabaseMetaData.getIndexInfo sorts results incorrectly.
     * 
     * @throws Exception
     *             if the test fails.
     */
     ...
     * 
     * old.Test duplicated in testsuite.regression.jdbc4.MetaDataRegressionTest.
     * 
     * @throws Exception
     *             if the test fails.
     */

...
public class LoginUtils {
    ...
    public static boolean isEnabledUser(String userId, String password) throws FailedDatabaseAccessException {
        try (MySql mysql = new MySql()) {
            try {
                ...
                return goodThrough.toLocalDate().isAfter(LocalDate.now());
            }
